...
const CAPABILITIES = {
  ...
  railClient: {
    rails: ['listRails', 'explainRail', 'getRailStats'],
    tunnels: ['listTunnels', 'getTunnel', 'createTunnel', 'closeTunnel'],
    consensus: ['listConsensus', 'getConsensus', 'createConsensus'],
    routes: ['listRoutes', 'getRoute', 'createRoute', 'deleteRoute']
  }
};
