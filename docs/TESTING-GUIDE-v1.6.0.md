...
**Version:** 1.6.0
**Branch:** `claude/mcp-compliance-review-hardening-011CV4DVd434Mj4UvYfrW9C3`
**Date:** November 12, 2025
**Test Window:** Now - November 25, 2025 (MCP final release)
...
- ✅ November 2025 MCP draft spec readiness
...
```bash
# Once v1.6.0 is published to npm
npx @terminals-tech/openrouter-agents@1.6.0 --stdio
```
